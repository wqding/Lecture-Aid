...
const LOCAL_URL = "http://34.197.116.174:8000/summarize/"

const HomePage = ({navigation}) => {
    const getSummary = () => {
        axios.post(LOCAL_URL, {
            ...
            console.log("summary is: " + res.data);
        })
        .catch(err => {
            console.log(err)
        });
    ...
    return(
        <View style={styles.container}>
            ...
            <Button 
                ...
                // pretty sure can pass props into Recordings component: navigation.navigate('Profile', {name: 'Jane'})
                onPress={() => navigation.navigate('RecordingsPage')}
            />
        </View>
    )
}
